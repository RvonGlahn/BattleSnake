...
class Decision:
    ...
    def _update_automats(self, board: BoardState, kill_board: np.ndarray, grid_map: GridMap) -> None:
        ...
        self.automats[self.my_snake_id].update_my_state(board, kill_board, grid_map)
